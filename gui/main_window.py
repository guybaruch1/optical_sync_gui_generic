...
class MainWindow(QMainWindow):
    ...
    def _on_calibration_done(self):
        ...
        self._pending_ctx = dict(
            ...
            clean_csv_filename=self.settings["paths"]["clean_csv_path"],
            other_csv_filename=self.settings["paths"]["other_csv_path"],
    ...
    def _on_tuning_done(self):
        ...
        self.live_session_page.set_context(
            ...
            clean_csv_filename=pending["clean_csv_filename"],
            other_csv_filename=pending["other_csv_filename"],
